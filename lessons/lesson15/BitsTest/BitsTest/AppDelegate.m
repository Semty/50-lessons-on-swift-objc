...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    student.studiesBioligy = NO;
    student.studiesPsychology = NO;
    
    NSLog(@"%@", student); */
    
    student.subjectType = RTStudentSubjectTypeMath | RTStudentSubjectTypeAnatomy |
                          RTStudentSubjectTypeDevelopment | RTStudentSubjectTypeEngineering;
